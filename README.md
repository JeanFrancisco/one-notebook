...
As you can see in the preview image below. This project consists of a simple note editor, which can be used as a jornal. See the credits file, to learn more.
